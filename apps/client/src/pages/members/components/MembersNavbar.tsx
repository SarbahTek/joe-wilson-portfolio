      ...
      <div className="px-6 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <button
            ...
            className="bg-[#077DA7] text-white text-[10px] font-bold px-4 py-2 rounded-none uppercase tracking-wider hover:bg-[#05637f] transition-colors cursor-pointer disabled:opacity-70"
          >
            LOGOUT
          </button>
        </div>
          ...
          <div className="flex flex-col gap-8 font-inter px-4 md:px-8">
            ...
            <div className="mt-4 pb-12">
              <button
                onClick={handleLogout}
                disabled={logoutMutation.isPending}
                className="w-[85%] md:w-full bg-[#077DA7] text-white text-[13px] font-bold py-[18px] flex items-center justify-center rounded-none uppercase tracking-widest cursor-pointer hover:bg-[#066588] transition-colors disabled:opacity-70"
              >
                LOGOUT
              </button>
            </div>
