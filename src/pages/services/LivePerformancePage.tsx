...
const opportunities = [
  {
    ...
    desc: "Polished live bass sets tailored for corporate galas, award nights, and company celebrations of any scale.",
  },
  {
    icon: "ri-community-line",
    title: "Church Concerts",
    desc: "Anointed, high-energy bass performances for church concerts, worship nights, and gospel events.",
  },
  {
    icon: "ri-global-line",
    title: "Tours",
    desc: "Reliable, world-class touring musician available for national and international concert tours.",
  },
  {
    icon: "ri-vip-crown-line",
    title: "Private Shows",
    desc: "Exclusive, intimate performances crafted for private celebrations, weddings, and VIP functions.",
  },
];
...
const videos = [
  {
    id: "v1",
    title: "Live City Festival",
    category: "Live Performance",
    duration: "4:38",
    thumb: livePerformanceImg,
    youtubeId: "dQw4w9WgXcQ",
  },
  {
    id: "v2",
    title: "Nairobi Performances",
    category: "Live Performance",
    duration: "6:15",
    thumb: livePerformanceImg,
    youtubeId: "dQw4w9WgXcQ",
...
const steps = [
  {
    ...
    desc: "Fill out the quote form with your event details, preferred dates, and budget range.",
  },
  {
    num: "02",
    icon: "ri-discuss-line",
    title: "Discuss Requirements",
    desc: "We'll connect to walk through your vision, set list preferences, and technical requirements.",
  },
  {
    num: "03",
    icon: "ri-shake-hands-line",
    title: "Confirm Booking",
    desc: "Receive a custom proposal, sign the agreement, and secure your date with a deposit.",
  },
  {
    num: "04",
    icon: "ri-music-2-line",
    title: "Deliver Service",
    desc: "Joseph arrives fully prepared and delivers an unforgettable live performance at your event.",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8 items-start">
            ...
            <div>
              <p className="text-gray-300 text-sm leading-relaxed mb-6">
                Check out highlights from past performances and sessions
              </p>
